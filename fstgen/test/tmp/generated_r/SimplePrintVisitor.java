...
public class SimplePrintVisitor extends AbstractFSTPrintVisitor  {
	...
	public boolean visit(FSTNonTerminal nonTerminal) {
		...
		if (nonTerminal.getType().equals("FunctionDefinition")) {
			printFeatures(nonTerminal,true);
			{
				FSTNode v=getChild(nonTerminal, "funcdef");
				if (v!=null) {
					v.accept(this);
				}
			}
	...
	protected boolean isSubtype(String type, String expectedType) {
		...
		if (type.equals("subscriptlist1") && expectedType.equals("subscriptlist")) return true;
		...
		if (type.equals("subscriptlist2") && expectedType.equals("subscriptlist")) return true;
		...
		if (type.equals("assignType1") && expectedType.equals("assignType")) return true;
		...
		if (type.equals("assignType2") && expectedType.equals("assignType")) return true;
